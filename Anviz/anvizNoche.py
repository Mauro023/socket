...
def main():
    ...
    fecha_hora_inicio = datetime.combine(today, datetime.strptime('14:00:00', '%H:%M:%S').time())
    fecha_hora_fin = datetime.combine(today, datetime.strptime('18:00:00', '%H:%M:%S').time())
