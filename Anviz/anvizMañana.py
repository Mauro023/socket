...
# the year 2000
SSEC = datetime(2000, 1, 2, 0, 0).timestamp() # = datetime(2000, 1, 2, 0, 0).timestamp() in python3
...
def main():
    ...
    fecha_hora_fin = datetime.combine(today, datetime.strptime('12:00:00', '%H:%M:%S').time())
    ...
    while fecha_hora_inicio < fecha_hora_fin:
        ...
        for record in record_generator:
            ...
            if fecha == today and hora >= fecha_hora_inicio.time() and hora <= (fecha_hora_inicio + incremento).time():    
